...
{
private:
    int rowsSize; // Number of rows in the matrix
    int colsSize; // Number of columns in the matrix
    T** data;  // 2D array to hold matrix data
public:
    ...
    void allocateData(int,int);
    void fillData(int value,int ,int );
